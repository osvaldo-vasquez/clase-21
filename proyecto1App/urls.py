...
urlpatterns = [
    ...
    path('editar-libro/<int:libro_id>', views.editar_libro, name = "editarLibro"),
    path('editar-revista/<int:revista_id>', views.editar_revista, name = "editarRevista"),
    path('editar-autor/<int:autor_id>', views.editar_autor, name = "editarAutor"),
]